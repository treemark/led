// Moon phase animation v2 for Pixelblaze
// Two-circle crescent approach with exaggerated crescent past centerline
...
// How much to exaggerate the crescent (1.0 = normal, higher = more exaggerated)
...
function precomputeTerminator() {
    ...
    // Circle through 3 points: (0,-0.5), (mx,0), (0,0.5)
    // Center at (cx, 0) due to symmetry
    var absMx = abs(gMx)
...
function calculateMoonBrightness(dx, dy) {
    ...
    var terminatorBrightness = calculateTerminator(dx, dy)

    return moonEdge * terminatorBrightness
}
